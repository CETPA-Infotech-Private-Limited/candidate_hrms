...
function loadProfileData() {
    function getFrontEndObject() {
        var arrObjects = [
            ...
            { modelName: '', elementType: 'input', frontFieldName: 'inputMobileNo', apiFieldName: 'MobileNo', attrName: 'value', getFunction: 'val', setFunction: 'val', isReadOnly: true, isDisabled: true, isEditable: false },
            ...
            { modelName: '', elementType: 'input', frontFieldName: 'inputEmail', apiFieldName: 'EmailId', attrName: 'value', getFunction: 'val', setFunction: 'val', isReadOnly: true, isDisabled: true, isEditable: false },
